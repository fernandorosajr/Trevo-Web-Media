Public Class Control_ViewMenuBar
    ...
    Private Sub ButtonsEtiquetaDeSubTitulo_Click(sender As Object, e As EventArgs) Handles CKBEtiquetaDeSubTitulo_ExibirExtensao.Click, CKBEtiquetaDeSubTitulo_Legenda.Click, CKBEtiquetaDeSubTitulo_Resolucao.Click, CKBEtiquetaDeSubTitulo_Autor.Click, CKBEtiquetaDeSubTitulo_Album.Click, CKBEtiquetaDeSubTitulo_Tipo.Click, CKBEtiquetaDeSubTitulo_DataDeCriacao.Click, CKBEtiquetaDeSubTitulo_DatasRecentes.Click, CKBEtiquetaDeSubTitulo_Tamanho.Click
